        ...
        park.map(parkData=>{
            return(
                <div className="parkCard">
                    ...
                    <h1 className='parkTitle'>{parkData.fullName} <AiOutlineCheckCircle cursor={'pointer'} className='like-checkmark' onClick={()=>likePark()} color={visitedPark? "rgb(0,0,225)" : "rgb(0,0,0)" }/></h1>
